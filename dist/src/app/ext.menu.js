...
var extmenuMetaData = (function () {
    function extmenuMetaData() {
    }
    extmenuMetaData.XTYPE = 'menu';
    extmenuMetaData.INPUTNAMES = [
        'activeItem',
        'alwaysOnTop',
        'anchor',
        'anchorPosition',
...
var extmenu = (function (_super) {
    __extends(extmenu, _super);
    function extmenu(eRef, resolver, vcRef) {
        _super.call(this, eRef, resolver, vcRef, extmenuMetaData);
    }
    extmenu.prototype.ngAfterContentInit = function () { this.AfterContentInit(this.extbaseRef); };
    extmenu.prototype.ngOnInit = function () { this.OnInit(this.dynamicRef, extmenuMetaData); };
    __decorate([
        core_1.ContentChildren(ext_base_1.extbase, { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.QueryList)
    ], extmenu.prototype, "extbaseRef", void 0);
    __decorate([
        core_1.ViewChild('dynamic', { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.ViewContainerRef)
    ], extmenu.prototype, "dynamicRef", void 0);
    extmenu = __decorate([
        core_1.Component({
            selector: 'ext-' + extmenuMetaData.XTYPE,
            inputs: extmenuMetaData.INPUTNAMES,
            outputs: extmenuMetaData.OUTPUTNAMES,
            providers: [{ provide: ext_base_1.extbase, useExisting: core_1.forwardRef(function () { return extmenu; }) }],
