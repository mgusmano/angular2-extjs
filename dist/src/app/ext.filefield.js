...
var extfilefieldMetaData = (function () {
    function extfilefieldMetaData() {
    }
    extfilefieldMetaData.XTYPE = 'filefield';
    extfilefieldMetaData.INPUTNAMES = [
        'accept',
        'alwaysOnTop',
        'axisLock',
        'baseCls',
    ...
    extfilefieldMetaData.OUTPUTNAMES = [
        'added',
        'beforehide',
...
var extfilefield = (function (_super) {
    __extends(extfilefield, _super);
    function extfilefield(eRef, resolver, vcRef) {
        _super.call(this, eRef, resolver, vcRef, extfilefieldMetaData);
    }
    extfilefield.prototype.ngAfterContentInit = function () { this.AfterContentInit(this.extbaseRef); };
    extfilefield.prototype.ngOnInit = function () { this.OnInit(this.dynamicRef, extfilefieldMetaData); };
    __decorate([
        core_1.ContentChildren(ext_base_1.extbase, { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.QueryList)
    ], extfilefield.prototype, "extbaseRef", void 0);
    __decorate([
        core_1.ViewChild('dynamic', { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.ViewContainerRef)
    ], extfilefield.prototype, "dynamicRef", void 0);
    extfilefield = __decorate([
        core_1.Component({
            selector: 'ext-' + extfilefieldMetaData.XTYPE,
            inputs: extfilefieldMetaData.INPUTNAMES,
            outputs: extfilefieldMetaData.OUTPUTNAMES,
            providers: [{ provide: ext_base_1.extbase, useExisting: core_1.forwardRef(function () { return extfilefield; }) }],
...
exports.extfilefield = extfilefield;
