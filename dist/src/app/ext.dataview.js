...
var extdataviewMetaData = (function () {
    function extdataviewMetaData() {
    }
    extdataviewMetaData.XTYPE = 'dataview';
    extdataviewMetaData.INPUTNAMES = [
        'activeItem',
        'allowDeselect',
        'alwaysOnTop',
        'autoDestroy',
    ...
    extdataviewMetaData.OUTPUTNAMES = [
        'activate',
        'add',
        'added',
        'beforehide',
...
var extdataview = (function (_super) {
    __extends(extdataview, _super);
    function extdataview(eRef, resolver, vcRef) {
        _super.call(this, eRef, resolver, vcRef, extdataviewMetaData);
    }
    extdataview.prototype.ngAfterContentInit = function () { this.AfterContentInit(this.extbaseRef); };
    extdataview.prototype.ngOnInit = function () { this.OnInit(this.dynamicRef, extdataviewMetaData); };
    __decorate([
        core_1.ContentChildren(ext_base_1.extbase, { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.QueryList)
    ], extdataview.prototype, "extbaseRef", void 0);
    __decorate([
        core_1.ViewChild('dynamic', { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.ViewContainerRef)
    ], extdataview.prototype, "dynamicRef", void 0);
    extdataview = __decorate([
        core_1.Component({
            selector: 'ext-' + extdataviewMetaData.XTYPE,
            inputs: extdataviewMetaData.INPUTNAMES,
            outputs: extdataviewMetaData.OUTPUTNAMES,
            providers: [{ provide: ext_base_1.extbase, useExisting: core_1.forwardRef(function () { return extdataview; }) }],
...
exports.extdataview = extdataview;
