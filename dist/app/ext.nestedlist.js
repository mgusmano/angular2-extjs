...
var extnestedlistMetaData = (function () {
    function extnestedlistMetaData() {
    }
    extnestedlistMetaData.XTYPE = 'nestedlist';
    extnestedlistMetaData.INPUTNAMES = [
        'activeItem',
        'allowDeselect',
        'alwaysOnTop',
        'autoDestroy',
    ...
    extnestedlistMetaData.OUTPUTNAMES = [
        'activate',
        'add',
        'added',
        'back',
...
var extnestedlist = (function (_super) {
    __extends(extnestedlist, _super);
    function extnestedlist(eRef, resolver, vcRef) {
        _super.call(this, eRef, resolver, vcRef, extnestedlistMetaData);
    }
    extnestedlist.prototype.ngAfterContentInit = function () { this.AfterContentInit(this.extbaseRef); };
    extnestedlist.prototype.ngOnInit = function () { this.OnInit(this.dynamicRef, extnestedlistMetaData); };
    __decorate([
        core_1.ContentChildren(ext_base_1.extbase, { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.QueryList)
    ], extnestedlist.prototype, "extbaseRef", void 0);
    __decorate([
        core_1.ViewChild('dynamic', { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.ViewContainerRef)
    ], extnestedlist.prototype, "dynamicRef", void 0);
    extnestedlist = __decorate([
        core_1.Component({
            selector: 'ext-' + extnestedlistMetaData.XTYPE,
            inputs: extnestedlistMetaData.INPUTNAMES,
            outputs: extnestedlistMetaData.OUTPUTNAMES,
            providers: [{ provide: ext_base_1.extbase, useExisting: core_1.forwardRef(function () { return extnestedlist; }) }],
...
exports.extnestedlist = extnestedlist;
