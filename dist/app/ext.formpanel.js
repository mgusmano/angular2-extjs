...
var extformpanelMetaData = (function () {
    function extformpanelMetaData() {
    }
    extformpanelMetaData.XTYPE = 'formpanel';
    extformpanelMetaData.INPUTNAMES = [
        'activeItem',
        'alwaysOnTop',
        'anchor',
        'anchorPosition',
    ...
    extformpanelMetaData.OUTPUTNAMES = [
        'activate',
        'add',
        'added',
        'beforehide',
...
var extformpanel = (function (_super) {
    __extends(extformpanel, _super);
    function extformpanel(eRef, resolver, vcRef) {
        _super.call(this, eRef, resolver, vcRef, extformpanelMetaData);
    }
    extformpanel.prototype.ngAfterContentInit = function () { this.AfterContentInit(this.extbaseRef); };
    extformpanel.prototype.ngOnInit = function () { this.OnInit(this.dynamicRef, extformpanelMetaData); };
    __decorate([
        core_1.ContentChildren(ext_base_1.extbase, { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.QueryList)
    ], extformpanel.prototype, "extbaseRef", void 0);
    __decorate([
        core_1.ViewChild('dynamic', { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.ViewContainerRef)
    ], extformpanel.prototype, "dynamicRef", void 0);
    extformpanel = __decorate([
        core_1.Component({
            selector: 'ext-' + extformpanelMetaData.XTYPE,
            inputs: extformpanelMetaData.INPUTNAMES,
            outputs: extformpanelMetaData.OUTPUTNAMES,
            providers: [{ provide: ext_base_1.extbase, useExisting: core_1.forwardRef(function () { return extformpanel; }) }],
...
exports.extformpanel = extformpanel;
