...
var exttextareafieldMetaData = (function () {
    function exttextareafieldMetaData() {
    }
    exttextareafieldMetaData.XTYPE = 'textareafield';
    exttextareafieldMetaData.INPUTNAMES = [
        'alwaysOnTop',
        'autoCapitalize',
        'autoComplete',
        'autoCorrect',
    ...
    exttextareafieldMetaData.OUTPUTNAMES = [
        'action',
        'added',
        'beforehide',
...
var exttextareafield = (function (_super) {
    __extends(exttextareafield, _super);
    function exttextareafield(eRef, resolver, vcRef) {
        _super.call(this, eRef, resolver, vcRef, exttextareafieldMetaData);
    }
    exttextareafield.prototype.ngAfterContentInit = function () { this.AfterContentInit(this.extbaseRef); };
    exttextareafield.prototype.ngOnInit = function () { this.OnInit(this.dynamicRef, exttextareafieldMetaData); };
    __decorate([
        core_1.ContentChildren(ext_base_1.extbase, { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.QueryList)
    ], exttextareafield.prototype, "extbaseRef", void 0);
    __decorate([
        core_1.ViewChild('dynamic', { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.ViewContainerRef)
    ], exttextareafield.prototype, "dynamicRef", void 0);
    exttextareafield = __decorate([
        core_1.Component({
            ...
            providers: [{ provide: ext_base_1.extbase, useExisting: core_1.forwardRef(function () { return exttextareafield; }) }],
...
exports.exttextareafield = exttextareafield;
