...
var extsegmentedbuttonMetaData = (function () {
    function extsegmentedbuttonMetaData() {
    }
    extsegmentedbuttonMetaData.XTYPE = 'segmentedbutton';
    extsegmentedbuttonMetaData.INPUTNAMES = [
        'activeItem',
        'allowDepress',
        'allowMultiple',
        'allowToggle',
    ...
    extsegmentedbuttonMetaData.OUTPUTNAMES = [
        'activate',
        'add',
        'added',
        'beforehide',
...
var extsegmentedbutton = (function (_super) {
    __extends(extsegmentedbutton, _super);
    function extsegmentedbutton(eRef, resolver, vcRef) {
        _super.call(this, eRef, resolver, vcRef, extsegmentedbuttonMetaData);
    }
    extsegmentedbutton.prototype.ngAfterContentInit = function () { this.AfterContentInit(this.extbaseRef); };
    extsegmentedbutton.prototype.ngOnInit = function () { this.OnInit(this.dynamicRef, extsegmentedbuttonMetaData); };
    __decorate([
        core_1.ContentChildren(ext_base_1.extbase, { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.QueryList)
    ], extsegmentedbutton.prototype, "extbaseRef", void 0);
    __decorate([
        core_1.ViewChild('dynamic', { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.ViewContainerRef)
    ], extsegmentedbutton.prototype, "dynamicRef", void 0);
    extsegmentedbutton = __decorate([
        core_1.Component({
            ...
            providers: [{ provide: ext_base_1.extbase, useExisting: core_1.forwardRef(function () { return extsegmentedbutton; }) }],
...
exports.extsegmentedbutton = extsegmentedbutton;
