...
var extviewportMetaData = (function () {
    function extviewportMetaData() {
    }
    extviewportMetaData.XTYPE = 'viewport';
    extviewportMetaData.INPUTNAMES = [
        'activeItem',
        'alwaysOnTop',
        'autoDestroy',
        'autoRender',
    ...
    extviewportMetaData.OUTPUTNAMES = [
        'activate',
        'add',
        'added',
        'beforehide',
...
var extviewport = (function (_super) {
    __extends(extviewport, _super);
    function extviewport(eRef, resolver, vcRef) {
        _super.call(this, eRef, resolver, vcRef, extviewportMetaData);
    }
    extviewport.prototype.ngAfterContentInit = function () { this.AfterContentInit(this.extbaseRef); };
    extviewport.prototype.ngOnInit = function () { this.OnInit(this.dynamicRef, extviewportMetaData); };
    __decorate([
        core_1.ContentChildren(ext_base_1.extbase, { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.QueryList)
    ], extviewport.prototype, "extbaseRef", void 0);
    __decorate([
        core_1.ViewChild('dynamic', { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.ViewContainerRef)
    ], extviewport.prototype, "dynamicRef", void 0);
    extviewport = __decorate([
        core_1.Component({
            selector: 'ext-' + extviewportMetaData.XTYPE,
            inputs: extviewportMetaData.INPUTNAMES,
            outputs: extviewportMetaData.OUTPUTNAMES,
            providers: [{ provide: ext_base_1.extbase, useExisting: core_1.forwardRef(function () { return extviewport; }) }],
...
exports.extviewport = extviewport;
