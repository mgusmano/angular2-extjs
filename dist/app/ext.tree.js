...
var exttreeMetaData = (function () {
    function exttreeMetaData() {
    }
    exttreeMetaData.XTYPE = 'tree';
    exttreeMetaData.INPUTNAMES = [
        'activeItem',
        'allowDeselect',
        'alwaysOnTop',
        'autoDestroy',
...
var exttree = (function (_super) {
    __extends(exttree, _super);
    function exttree(eRef, resolver, vcRef) {
        _super.call(this, eRef, resolver, vcRef, exttreeMetaData);
    }
    exttree.prototype.ngAfterContentInit = function () { this.AfterContentInit(this.extbaseRef); };
    exttree.prototype.ngOnInit = function () { this.OnInit(this.dynamicRef, exttreeMetaData); };
    __decorate([
        core_1.ContentChildren(ext_base_1.extbase, { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.QueryList)
    ], exttree.prototype, "extbaseRef", void 0);
    __decorate([
        core_1.ViewChild('dynamic', { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.ViewContainerRef)
    ], exttree.prototype, "dynamicRef", void 0);
    exttree = __decorate([
        core_1.Component({
            selector: 'ext-' + exttreeMetaData.XTYPE,
            inputs: exttreeMetaData.INPUTNAMES,
            outputs: exttreeMetaData.OUTPUTNAMES,
            providers: [{ provide: ext_base_1.extbase, useExisting: core_1.forwardRef(function () { return exttree; }) }],
