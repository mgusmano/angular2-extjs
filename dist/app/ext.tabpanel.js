...
var exttabpanelMetaData = (function () {
    function exttabpanelMetaData() {
    }
    exttabpanelMetaData.XTYPE = 'tabpanel';
    exttabpanelMetaData.INPUTNAMES = [
        'activeItem',
        'alwaysOnTop',
        'autoDestroy',
        'axisLock',
    ...
    exttabpanelMetaData.OUTPUTNAMES = [
        'activate',
        'add',
        'added',
        'beforehide',
...
var exttabpanel = (function (_super) {
    __extends(exttabpanel, _super);
    function exttabpanel(eRef, resolver, vcRef) {
        _super.call(this, eRef, resolver, vcRef, exttabpanelMetaData);
    }
    exttabpanel.prototype.ngAfterContentInit = function () { this.AfterContentInit(this.extbaseRef); };
    exttabpanel.prototype.ngOnInit = function () { this.OnInit(this.dynamicRef, exttabpanelMetaData); };
    __decorate([
        core_1.ContentChildren(ext_base_1.extbase, { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.QueryList)
    ], exttabpanel.prototype, "extbaseRef", void 0);
    __decorate([
        core_1.ViewChild('dynamic', { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.ViewContainerRef)
    ], exttabpanel.prototype, "dynamicRef", void 0);
    exttabpanel = __decorate([
        core_1.Component({
            selector: 'ext-' + exttabpanelMetaData.XTYPE,
            inputs: exttabpanelMetaData.INPUTNAMES,
            outputs: exttabpanelMetaData.OUTPUTNAMES,
            providers: [{ provide: ext_base_1.extbase, useExisting: core_1.forwardRef(function () { return exttabpanel; }) }],
...
exports.exttabpanel = exttabpanel;
