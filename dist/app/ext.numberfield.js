...
var extnumberfieldMetaData = (function () {
    function extnumberfieldMetaData() {
    }
    extnumberfieldMetaData.XTYPE = 'numberfield';
    extnumberfieldMetaData.INPUTNAMES = [
        'alwaysOnTop',
        'autoCapitalize',
        'autoComplete',
        'autoCorrect',
    ...
    extnumberfieldMetaData.OUTPUTNAMES = [
        'action',
        'added',
        'beforehide',
...
var extnumberfield = (function (_super) {
    __extends(extnumberfield, _super);
    function extnumberfield(eRef, resolver, vcRef) {
        _super.call(this, eRef, resolver, vcRef, extnumberfieldMetaData);
    }
    extnumberfield.prototype.ngAfterContentInit = function () { this.AfterContentInit(this.extbaseRef); };
    extnumberfield.prototype.ngOnInit = function () { this.OnInit(this.dynamicRef, extnumberfieldMetaData); };
    __decorate([
        core_1.ContentChildren(ext_base_1.extbase, { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.QueryList)
    ], extnumberfield.prototype, "extbaseRef", void 0);
    __decorate([
        core_1.ViewChild('dynamic', { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.ViewContainerRef)
    ], extnumberfield.prototype, "dynamicRef", void 0);
    extnumberfield = __decorate([
        core_1.Component({
            ...
            providers: [{ provide: ext_base_1.extbase, useExisting: core_1.forwardRef(function () { return extnumberfield; }) }],
...
exports.extnumberfield = extnumberfield;
