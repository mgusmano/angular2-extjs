...
var exttooltipMetaData = (function () {
    function exttooltipMetaData() {
    }
    exttooltipMetaData.XTYPE = 'tooltip';
    exttooltipMetaData.INPUTNAMES = [
        'activeItem',
        'align',
        'alignDelegate',
        'allowOver',
    ...
    exttooltipMetaData.OUTPUTNAMES = [
        'activate',
        'add',
        'added',
        'beforehide',
...
var exttooltip = (function (_super) {
    __extends(exttooltip, _super);
    function exttooltip(eRef, resolver, vcRef) {
        _super.call(this, eRef, resolver, vcRef, exttooltipMetaData);
    }
    exttooltip.prototype.ngAfterContentInit = function () { this.AfterContentInit(this.extbaseRef); };
    exttooltip.prototype.ngOnInit = function () { this.OnInit(this.dynamicRef, exttooltipMetaData); };
    __decorate([
        core_1.ContentChildren(ext_base_1.extbase, { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.QueryList)
    ], exttooltip.prototype, "extbaseRef", void 0);
    __decorate([
        core_1.ViewChild('dynamic', { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.ViewContainerRef)
    ], exttooltip.prototype, "dynamicRef", void 0);
    exttooltip = __decorate([
        core_1.Component({
            selector: 'ext-' + exttooltipMetaData.XTYPE,
            inputs: exttooltipMetaData.INPUTNAMES,
            outputs: exttooltipMetaData.OUTPUTNAMES,
            providers: [{ provide: ext_base_1.extbase, useExisting: core_1.forwardRef(function () { return exttooltip; }) }],
