...
var extfieldsetMetaData = (function () {
    function extfieldsetMetaData() {
    }
    extfieldsetMetaData.XTYPE = 'fieldset';
    extfieldsetMetaData.INPUTNAMES = [
        'activeItem',
        'alwaysOnTop',
        'autoDestroy',
        'axisLock',
    ...
    extfieldsetMetaData.OUTPUTNAMES = [
        'activate',
        'add',
        'added',
        'beforehide',
...
var extfieldset = (function (_super) {
    __extends(extfieldset, _super);
    function extfieldset(eRef, resolver, vcRef) {
        _super.call(this, eRef, resolver, vcRef, extfieldsetMetaData);
    }
    extfieldset.prototype.ngAfterContentInit = function () { this.AfterContentInit(this.extbaseRef); };
    extfieldset.prototype.ngOnInit = function () { this.OnInit(this.dynamicRef, extfieldsetMetaData); };
    __decorate([
        core_1.ContentChildren(ext_base_1.extbase, { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.QueryList)
    ], extfieldset.prototype, "extbaseRef", void 0);
    __decorate([
        core_1.ViewChild('dynamic', { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.ViewContainerRef)
    ], extfieldset.prototype, "dynamicRef", void 0);
    extfieldset = __decorate([
        core_1.Component({
            selector: 'ext-' + extfieldsetMetaData.XTYPE,
            inputs: extfieldsetMetaData.INPUTNAMES,
            outputs: extfieldsetMetaData.OUTPUTNAMES,
            providers: [{ provide: ext_base_1.extbase, useExisting: core_1.forwardRef(function () { return extfieldset; }) }],
...
exports.extfieldset = extfieldset;
