...
var extpivotgridMetaData = (function () {
    function extpivotgridMetaData() {
    }
    extpivotgridMetaData.XTYPE = 'pivotgrid';
    extpivotgridMetaData.INPUTNAMES = [
        'activeItem',
        'allowDeselect',
        'alwaysOnTop',
        'autoDestroy',
    ...
    extpivotgridMetaData.OUTPUTNAMES = [
        'activate',
        'add',
        'added',
        'beforehide',
...
var extpivotgrid = (function (_super) {
    __extends(extpivotgrid, _super);
    function extpivotgrid(eRef, resolver, vcRef) {
        _super.call(this, eRef, resolver, vcRef, extpivotgridMetaData);
    }
    extpivotgrid.prototype.ngAfterContentInit = function () { this.AfterContentInit(this.extbaseRef); };
    extpivotgrid.prototype.ngOnInit = function () { this.OnInit(this.dynamicRef, extpivotgridMetaData); };
    __decorate([
        core_1.ContentChildren(ext_base_1.extbase, { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.QueryList)
    ], extpivotgrid.prototype, "extbaseRef", void 0);
    __decorate([
        core_1.ViewChild('dynamic', { read: core_1.ViewContainerRef }), 
        __metadata('design:type', core_1.ViewContainerRef)
    ], extpivotgrid.prototype, "dynamicRef", void 0);
    extpivotgrid = __decorate([
        core_1.Component({
            selector: 'ext-' + extpivotgridMetaData.XTYPE,
            inputs: extpivotgridMetaData.INPUTNAMES,
            outputs: extpivotgridMetaData.OUTPUTNAMES,
            providers: [{ provide: ext_base_1.extbase, useExisting: core_1.forwardRef(function () { return extpivotgrid; }) }],
...
exports.extpivotgrid = extpivotgrid;
