...
@Component({
  selector: 'x-' + xpolarMetaData.XTYPE,
	...
	providers: [{provide: xbase, useExisting: forwardRef(() => xpolar)}],
	template: '<template #dynamic></template>'
})
export class xpolar extends xbase {
	constructor(eRef:ElementRef,resolver:ComponentFactoryResolver,vcRef:ViewContainerRef) {
		super(eRef,resolver,vcRef,xpolarMetaData);
	}
	...
	ngOnInit() {this.OnInit(this.dynamicRef,xpolarMetaData);}
}
