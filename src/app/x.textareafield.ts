...
@Component({
  selector: 'x-' + xtextareafieldMetaData.XTYPE,
	...
	providers: [{provide: xbase, useExisting: forwardRef(() => xtextareafield)}],
	template: '<template #dynamic></template>'
})
export class xtextareafield extends xbase {
	constructor(eRef:ElementRef,resolver:ComponentFactoryResolver,vcRef:ViewContainerRef) {
		super(eRef,resolver,vcRef,xtextareafieldMetaData);
	}
	...
	ngOnInit() {this.OnInit(this.dynamicRef,xtextareafieldMetaData);}
}
