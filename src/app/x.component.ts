...
@Component({
  selector: 'x-' + xcomponentMetaData.XTYPE,
	...
	providers: [{provide: xbase, useExisting: forwardRef(() => xcomponent)}],
	template: '<template #dynamic></template>'
})
export class xcomponent extends xbase {
	constructor(eRef:ElementRef,resolver:ComponentFactoryResolver,vcRef:ViewContainerRef) {
		super(eRef,resolver,vcRef,xcomponentMetaData);
	}
	...
	ngOnInit() {this.OnInit(this.dynamicRef,xcomponentMetaData);}
}
