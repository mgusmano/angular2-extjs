...
@Component({
  selector: 'x-' + xpivotgridMetaData.XTYPE,
	...
	providers: [{provide: xbase, useExisting: forwardRef(() => xpivotgrid)}],
	template: '<template #dynamic></template>'
})
export class xpivotgrid extends xbase {
	constructor(eRef:ElementRef,resolver:ComponentFactoryResolver,vcRef:ViewContainerRef) {
		super(eRef,resolver,vcRef,xpivotgridMetaData);
	}
	...
	ngOnInit() {this.OnInit(this.dynamicRef,xpivotgridMetaData);}
}
