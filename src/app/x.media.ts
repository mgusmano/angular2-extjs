...
@Component({
  selector: 'x-' + xmediaMetaData.XTYPE,
	...
	providers: [{provide: xbase, useExisting: forwardRef(() => xmedia)}],
	template: '<template #dynamic></template>'
})
export class xmedia extends xbase {
	constructor(eRef:ElementRef,resolver:ComponentFactoryResolver,vcRef:ViewContainerRef) {
		super(eRef,resolver,vcRef,xmediaMetaData);
	}
	...
	ngOnInit() {this.OnInit(this.dynamicRef,xmediaMetaData);}
}
