...
@Component({
  selector: 'x-' + xviewportMetaData.XTYPE,
	...
	providers: [{provide: xbase, useExisting: forwardRef(() => xviewport)}],
	template: '<template #dynamic></template>'
})
export class xviewport extends xbase {
	constructor(eRef:ElementRef,resolver:ComponentFactoryResolver,vcRef:ViewContainerRef) {
		super(eRef,resolver,vcRef,xviewportMetaData);
	}
	...
	ngOnInit() {this.OnInit(this.dynamicRef,xviewportMetaData);}
}
