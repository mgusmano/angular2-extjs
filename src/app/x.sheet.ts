...
@Component({
  selector: 'x-' + xsheetMetaData.XTYPE,
	...
	providers: [{provide: xbase, useExisting: forwardRef(() => xsheet)}],
	template: '<template #dynamic></template>'
})
export class xsheet extends xbase {
	constructor(eRef:ElementRef,resolver:ComponentFactoryResolver,vcRef:ViewContainerRef) {
		super(eRef,resolver,vcRef,xsheetMetaData);
	}
	...
	ngOnInit() {this.OnInit(this.dynamicRef,xsheetMetaData);}
}
