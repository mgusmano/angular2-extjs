...
@Component({
  selector: 'x-' + xtextfieldMetaData.XTYPE,
	...
	providers: [{provide: xbase, useExisting: forwardRef(() => xtextfield)}],
	template: '<template #dynamic></template>'
})
export class xtextfield extends xbase {
	constructor(eRef:ElementRef,resolver:ComponentFactoryResolver,vcRef:ViewContainerRef) {
		super(eRef,resolver,vcRef,xtextfieldMetaData);
	}
	...
	ngOnInit() {this.OnInit(this.dynamicRef,xtextfieldMetaData);}
}
