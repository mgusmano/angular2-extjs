...
@Component({
  selector: 'x-' + xpanelMetaData.XTYPE,
	...
	providers: [{provide: xbase, useExisting: forwardRef(() => xpanel)}],
	template: '<template #dynamic></template>'
})
export class xpanel extends xbase {
	constructor(eRef:ElementRef,resolver:ComponentFactoryResolver,vcRef:ViewContainerRef) {
		super(eRef,resolver,vcRef,xpanelMetaData);
	}
	...
	ngOnInit() {this.OnInit(this.dynamicRef,xpanelMetaData);}
}
