...
@Component({
  selector: 'x-' + xbuttonMetaData.XTYPE,
	...
	providers: [{provide: xbase, useExisting: forwardRef(() => xbutton)}],
	template: '<template #dynamic></template>'
})
export class xbutton extends xbase {
	constructor(eRef:ElementRef,resolver:ComponentFactoryResolver,vcRef:ViewContainerRef) {
		super(eRef,resolver,vcRef,xbuttonMetaData);
	}
	...
	ngOnInit() {this.OnInit(this.dynamicRef,xbuttonMetaData);}
}
